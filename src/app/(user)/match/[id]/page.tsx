      ...
      <Card className={cn(
        ...
        <div className={cn('px-6 py-4 flex items-center justify-between', sportColors.bg)}>
          <div className="flex items-center gap-3">
            ...
            {fixture.round && (
              <span className="text-sm text-gray-600">• {fixture.round}</span>
            )}
          </div>
          <div className="flex items-center gap-3">
            {isLive && (
        ...
        <div className="p-6">
          <div className="grid grid-cols-3 gap-4 items-center">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">{fixture.team_a.short_name}</p>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">{fixture.team_b.short_name}</p>
          ...
          {isCompleted && fixture.summary && (
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">{fixture.summary}</p>
            </div>
          )}
        </div>
      </Card>
          ...
          <div className="space-y-3">
            ...
            {fixture.match_number && (
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-gray-600">Match {fixture.match_number}</span>
              </div>
            )}
          </div>
        </Card>
